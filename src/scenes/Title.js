class Title extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('duncan', 'img/bob.png');
        this.load.image('malcolm', 'img/cat.png');
        this.load.image('sergeant', 'img/mario.png');
        this.load.image('lennox', 'img/mouse.png');
        this.load.image('ross', 'img/pikachu.png');
